...
const NAV_ITEMS = [
  { href: "/office/rebound/dashboard", label: "لوحة التحكم", labelEn: "Dashboard", icon: icons.dashboard },
  { href: "/office/rebound/clients", label: "إدارة العملاء", labelEn: "Clients", icon: icons.clients },
...
export function ReboundSidebar() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem("rebound-theme") as "light" | "dark" | null;
    if (saved) {
      setTheme(saved);
  ...
  const toggleTheme = () => {
    ...
    setTheme(next);
    localStorage.setItem("rebound-theme", next);
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <Link
            ...
            style={{
              ...
              color: "#3b82f6", textDecoration: "none", flexShrink: 0,
            }}
